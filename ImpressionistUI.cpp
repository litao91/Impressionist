...
//Set up the stroke
//----------------------------------------------
void ImpressionistUI::cb_strok_dir_choice(Fl_Widget* o, void* v)
{
}

void ImpressionistUI::cb_line_width_slider(Fl_Widget* o, void* v)
{
}
...
{
	fl_message("Impressionist FLTK version for CS341, Spring 2012");
}
...
//--------------------------------------------------------
// Set the color
// Call the by UI when the Color Button is clicked
//--------------------------------------------------------
void ImpressionistUI::cb_choose_color(Fl_Menu_* o, void* v) 
{

}

//----------------------------------------------------------
// Paintly call back, Call by the UI when the Button is clicked
//-----------------------------------------------------------
...
//-----------------------------------------------------
//LineHeight Slider callback
//---------------------------------------------------
void ImpressionistUI::cb_line_angle_slider(Fl_Widget* o, void* v)
{
	((ImpressionistUI*)(o->user_data()))->m_nAngle =int( ((Fl_Slider*)o)->value());
}
//-----------------------------------------------------
//Alpha value Slider callback
//---------------------------------------------------
void ImpressionistUI::cb_alpha_slider(Fl_Widget* o, void* v)
{
...
//Spacing slider
//---------------------------------------------------------
void ImpressionistUI::cb_spacing_slider(Fl_Widget* o, void* v) 
{
...
//Edge Threshold
//--------------------------------------------------------
void ImpressionistUI::cb_threshold_slider(Fl_Widget* o, void* v)
{
	((ImpressionistUI*)(o->user_data()))->m_nSpacing = int(((Fl_Slider*)o)->value());
}
...
// Show Original Image
//---------------------------------------------------------
void ImpressionistUI::cb_ori_image(Fl_Menu_* o, void* v)
{
#ifdef DEBUG
	printf("Original Image clicked\n");
#endif
}
//-----------------------------------------
//Edage the image
...
Fl_Menu_Item ImpressionistUI::menuitems[] = {
	{ "&File",		0, 0, 0, FL_SUBMENU },
		...
		{ "&Colors",        FL_ALT + 'k', (Fl_Callback *)ImpressionistUI::cb_choose_color, 0},
	...
	{ "&Display",   0, 0, 0, FL_SUBMENU},
		{ "&Original Image", FL_ALT + 'o', (Fl_Callback *)ImpressionistUI::cb_ori_image },
...
ImpressionistUI::ImpressionistUI() {
	...
	m_brushDialog = new Fl_Window(400, 325, "Brush Dialog");
		...
		//Add strok direction choice to dialog
		m_StrokeDirChoice = new Fl_Choice(115,45,180,25,"&Stroke Direction");
		m_StrokeDirChoice->user_data((void*)(this));
		m_StrokeDirChoice->callback(cb_strok_dir_choice);
		...
		m_LineWidthSlider->callback(cb_line_width_slider);
		...
		m_LineAngleSlider->callback(cb_line_angle_slider);
		...
		m_AlphaSlider->callback(cb_alpha_slider);

		m_EdgeClippingLightButton = new Fl_Light_Button(10, 200, 125, 20, "&Edge Clipping");
		m_EdgeClippingLightButton->user_data((void*)(this));
		m_EdgeClippingLightButton->labelfont(FL_COURIER);
		m_EdgeClippingLightButton->value(m_eClipping);

		m_SpacingSlider = new Fl_Value_Slider(10, 230, 140, 20, "Spacing");
		...
		m_SpacingSlider->callback(cb_spacing_slider);
